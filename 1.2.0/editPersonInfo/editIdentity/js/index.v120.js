        ...
        for (var i = 0; i < userIdentity.length; i++) {
            if (userIdentity[i].user_identity_information_id == identityId) {
                if (userIdentity[i].identity_type == 2) {
                    if (userIdentity[i].top_identity == 2) {
                        console.log("置顶");
                        $("#commerceSelected").css("border", "1px solid transparent");
                        $("#comselect").css("display", "block");
                        $.setStore("commerceIdentityInfo", {
                            top_identity: 2
                        });
                        ...
                        $("#commerceSelected").css("border", "1px solid #999");
                        $("#busselect").css("display", "none");
                        $.setStore("identityInfo", {
                            top_identity: 1
                        });
                ...
                if (userIdentity[i].identity_type == 1) {
                    if (userIdentity[i].top_identity == 2) {
                        console.log("置顶");
                        $("#businessSelected").css("border", "1px solid transparent");
                        $("#busselect").css("display", "block");
                        $.setStore("identityInfo", {
                            top_identity: 2
                        });
                        ...
                        $("#businessSelected").css("border", "1px solid #999");
                        $("#busselect").css("display", "none");
                        $.setStore("identityInfo", {
                            top_identity: 1
                        });
